  ...
  function(req, email, password, done) {
    ...
    MongoClient.connect(connection_string, function (err, db) {
      if(err) {
        ...
        collection.findOne({"_id": userEmail}, function(err, doc) {

          if(!doc) { // entry not found new user 
            collection.insert( { "_id": userEmail ,password:userPassword , emailUuid: userVerifyUuid, userName : userName, isEmailValidated:false } );
