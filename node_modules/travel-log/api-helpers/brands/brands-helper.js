...
var brands = function() {
  // Fetch the brands details from DB using the provided location ID

  //format for call back: callback(returnMsg,returnData);
  this.getBrandsByLocationId = function(req, res, locationId, callback) {
  ...
  this.searchBrandsByName = function(req, res, searchArray, callback) {
   ...
   //format for call back: callback(returnMsg,returnData);
  this.getBrandsByShopProfileId = function(req, res, shopProfileId, callback) {
   ...
   //format for call back: callback(returnMsg,returnData);
  this.getAllBrands = function(req, res, callback) {
