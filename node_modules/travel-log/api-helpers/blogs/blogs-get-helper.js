      ...
      if(err) {
        ...
        cursor.each(function(err, doc) {
          if(doc!=null){ 
            var blogArray = []; 
            blogArray = doc.blogs;
            aggregatePostsCount += blogArray.length;
      ...
      if(err) {
        ...
        blog_tbl.findOne({"_id": location_name}, function(err, doc) {
          if(!doc){
            ...
            returnMsg = 'success';
            postArray.push(doc);
            returnData['postArray'] = postArray;
            returnData['aggregatePostsCount'] = doc['totalBlogCount'];
            callback(returnMsg, returnData);
            return;
          }
        });
