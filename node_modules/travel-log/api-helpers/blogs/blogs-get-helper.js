      ...
      if(err) {
        ...
        cursor.each(function(err, doc) {
          if(doc!=null) { 
            ...
            if(proximtyFinder.isProximityInRange(userLatLongObj,dbLatLongObj)){
            ...
            location_tbl.findOne({'country': req.query.user_country_name}, function(err, doc) {
              if(!doc) { 
                  console.log("Oops!! The location you are looking for does not exists");
                  returnData['aggregatePostsCount'] = aggregatePostsCount;
                  returnData = resultPostsArr;
                  callback(returnMsg, resultPostsArr);
                  return;
              } else {
                console.log(doc);
                returnData['blogs'] = resultPostsArr;
                returnData['locationMetaData'] = doc['details'];
                returnData['aggregatePostsCount'] = aggregatePostsCount;
