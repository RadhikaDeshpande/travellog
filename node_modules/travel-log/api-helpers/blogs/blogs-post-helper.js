      ...
      _uploadToImageServer(foodImagesArray,function(foodImagesArray) {
        MongoClient.connect(connection_string, function (err, db) {
          if(err) {
            ...
            foodObj['foodDescription'] = req.body.foodDescription;
            ...
            food_tbl.findOne({"_id": req.body.foodJointName,location:req.body.location }, function(err, doc) {
              if(!doc) { // New entry do an insert
                food_tbl.insert({"_id": req.body.foodJointName, visitCount:1, location:req.body.location,"content" :foodObj});
              } else {
                food_tbl.update({"_id":req.body.foodJointName, location:req.body.location },{$inc : {visitCount : 1}},function(err,result) {
                });
              }
            });
